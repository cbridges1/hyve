...
log "Applying CRDs"
kubectl apply -f "$ROOT_DIR/deploy/helm/hyve/crds/hyve.io_clusterdefinitions.yaml" >/dev/null
kubectl apply -f "$ROOT_DIR/deploy/helm/hyve/crds/hyve.io_hyveconfigs.yaml" >/dev/null
