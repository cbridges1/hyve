...
// HyveConfigForm is the shared editing surface both SettingsPage (control
// plane's own home-cluster singleton) and OrgSettingsPage (an organization's
// own dedicated-reconciling-cluster singleton) render — identical fields,
// identical save/validate behavior, differing only in which HyveConfig this
// call's title/description/get/update actually target.
export function HyveConfigForm({
  title,
  description,
  config,
  loading,
  ...
  config: HyveConfig | null | undefined
  loading: boolean
  error: string | null
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="mt-0.5 text-sm text-neutral-500">
          {description} {config && !config.exists && 'Not created yet — saving will create it.'}
        </p>
      </div>
